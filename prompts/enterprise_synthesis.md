...
- Start your answer by directly echoing the question's key noun/phrase. Example: if asked "what does the X document describe?", begin with "The X document describes..."
